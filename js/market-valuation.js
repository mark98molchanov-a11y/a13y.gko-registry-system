...
<p class="text-xs text-slate-400 mt-1">Введите полную кадастровую стоимость объекта. Если не заполнено — будет использована медиана по городу + каскад</p>
    ...
    downloadTemplate() {
       ...
       const template = [
            ...
            {'Тип объекта':'Земельный участок','Площадь (м²)':600,'Город (МО)':'Ноябрьск','Материал стен':'','Наименование':'','Назначение':'','Год постройки':2024,'ВРИ (для земли)':'для ИЖС','Категория земель':'Земли населенных пунктов','Кадастровый номер':'','КС (полная, ₽)':''},
