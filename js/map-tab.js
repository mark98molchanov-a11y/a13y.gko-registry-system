...
L.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png?key=cb1_3uly_1_5f67cc4b44300afbb4afba80', {
    ...
    if (filteredDeals.length === 0) {
        ...
        displayDeals.forEach((deal, index) => {
            ...
            html += `
                ...
                <td style="text-align: center; padding: 6px 6px; font-size: 10px; color: #1e293b; font-weight: 400; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="${deal.cad_number || 'nan'}">${deal.cad_number || 'nan'}</td>
                <td style="text-align: center; padding: 6px 6px; font-size: 10px; color: #1e293b; font-weight: 400;">${deal.cad_nspd || 'nan'}</td>
                <td style="text-align: center; padding: 6px 6px; color: #1e293b; font-weight: 400; font-size: 10px;">${deal.cadastral_value ? deal.cadastral_value.toLocaleString('ru-RU') : 'nan'}</td>
